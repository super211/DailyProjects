...
public class LargeOrderFilter {
	...
	public void writeOutFiltrdAndPriceSortedOrders(OrderWriter writer) {
		...
		Collections.sort(filteredOrders, new Comparator() {//suggest to remove the unchecked conversion warning for keeping type safty and avoiding exceptions like ClassCastException. Change it to Comparator<Object>() 
			@Override
			public int compare(Object o1, Object o2) {
				Order order1 = (Order) o1;
				Order order2 = (Order) o2;
				return (int) (order1.getPrice() - order2.getPrice());//here conversion from double to int may cause some business problems.
			}
		});
