...
public class XsltTransformation2

{
...

	{
		...
		if (args.length != 3) {
			...
			System.err.println("XSLTTest data/input.xml data/transform.xslt data/output2.html");
			return;
		}
		...
		XsltTransformation2 st = new XsltTransformation2();
